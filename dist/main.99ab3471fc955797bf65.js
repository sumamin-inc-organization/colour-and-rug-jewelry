...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (Instafeed);

/***/ }),

/***/ "./src/assets/css/advantage.css":
/*!**************************************!*\
  !*** ./src/assets/css/advantage.css ***!
  \**************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/assets/css/consultancy.css":
/*!****************************************!*\
  !*** ./src/assets/css/consultancy.css ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/assets/css/inspiration.css":
/*!****************************************!*\
  !*** ./src/assets/css/inspiration.css ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/***/ "./src/assets/css/recommended.css":
/*!****************************************!*\
  !*** ./src/assets/css/recommended.css ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _assets_css_common_utillity_css__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./assets/css/common/utillity.css */ "./src/assets/css/common/utillity.css");
...
/* harmony import */ var _assets_css_contact_css__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./assets/css/contact.css */ "./src/assets/css/contact.css");
...
/* harmony import */ var instafeed_js__WEBPACK_IMPORTED_MODULE_31__ = __webpack_require__(/*! instafeed.js */ "./node_modules/instafeed.js/dist/instafeed.es.js");
...
function horizontalLoop(items, config) {
  items = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.utils.toArray(items);
  config = config || {};
  let tl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
    ...
    item,
    i;
  gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.set(items, {
    // convert "x" to "xPercent" to make things responsive, and populate the widths/xPercents Arrays to make lookups faster.
    xPercent: (i, el) => {
      let w = (widths[i] = parseFloat(gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.getProperty(el, "width", "px")));
      xPercents[i] = snap(
        (parseFloat(gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.getProperty(el, "x", "px")) / w) * 100 +
          gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.getProperty(el, "xPercent")
      );
      return xPercents[i];
    },
  });
  gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.set(items, { x: 0 });
  totalWidth =
    items[length - 1].offsetLeft +
    (xPercents[length - 1] / 100) * widths[length - 1] -
    startX +
    items[length - 1].offsetWidth *
      gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.getProperty(items[length - 1], "scaleX") +
  ...
  for (i = 0; i < length; i++) {
    ...
    distanceToLoop =
      distanceToStart + widths[i] * gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.getProperty(item, "scaleX");
    tl.to(
      item,
      {
  ...
  function toIndex(index, vars) {
    ...
    let newIndex = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.utils.wrap(0, length, index),
      time = times[newIndex];
    if (time > tl.time() !== index > curIndex) {
      // if we're wrapping the timeline's playhead, make the proper adjustments
      vars.modifiers = { time: gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.utils.wrap(0, tl.duration()) };
...
const listItem = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.utils.toArray(".list__item");


function flowText(scrollerClass,itemClass){

  gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.utils.toArray(scrollerClass).forEach((line, i) => {
    const links = line.querySelectorAll(itemClass),
          tl = horizontalLoop(links, {
            repeat: -1, 
            speed: 1 + i * 0.5,
            reversed: i ? true : false,
            paddingRight: parseFloat(gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.getProperty(links[0], "marginRight", "px")) // otherwise first element would be right up against the last when it loops. In this layout, the spacing is done with marginRight.
          });
  });
}
...
/*----------------------------
    ...
    RECOMMENDED  アニメーション
----------------------------*/
let recommendedtl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
  scrollTrigger: {
    trigger: "#recommended",
    start: "-=500px",
    scrub: false,
...
let inspirationtl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
  scrollTrigger: {
    trigger: "#inspiration",
    start: "-=500px",
    scrub: false,
...
let advantagetl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
  scrollTrigger: {
    trigger: "#advantage",
    start: "-=500px",
    scrub: false,
...
let consultancytl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
  scrollTrigger: {
    trigger: "#consultancy",
    start: "-=500px",
    scrub: false,
...
let itemtl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
  scrollTrigger: {
    trigger: "#item",
    start: "-=500px",
    scrub: false,
...
itemtl
  ...
  /*----------------------------
    ...
    Plan アニメーション
----------------------------*/
let plantl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
  scrollTrigger: {
    trigger: "#plan",
    start: "-=500px",
    scrub: false,
...
let flowtl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
  scrollTrigger: {
    trigger: "#flow",
    start: "-=500px",
    scrub: false,
...
let gallerytl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
  scrollTrigger: {
    trigger: "#gallery",
    start: "-=500px",
    scrub: false,
...
let faqtl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
  scrollTrigger: {
    trigger: "#faq",
    start: "-=500px",
    scrub: false,
...
let conttl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
  scrollTrigger: {
    trigger: "#contact",
    start: "-=500px",
    scrub: false,
...
function openNav(){
  let openAnim = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline()
  openAnim
  ...
  document.documentElement.style.overflow = 'hidden';
  document.body.style.overflow = 'hidden';
  currentLogoColor =  (0,_assets_js_logoColorAttribute__WEBPACK_IMPORTED_MODULE_27__.CheckCurrentColor)("logo")

  ;(0,_assets_js_changeLogoColor__WEBPACK_IMPORTED_MODULE_25__.UpdateNavLogoWhite)();
...
function closeNav(){
  ...
  currentLogoColor =  (0,_assets_js_logoColorAttribute__WEBPACK_IMPORTED_MODULE_27__.CheckCurrentColor)("logo")
  ;(0,_assets_js_logoColorAttribute__WEBPACK_IMPORTED_MODULE_27__.updateColor)(currentLogoColor,"logo");
  (0,_assets_js_logoColorAttribute__WEBPACK_IMPORTED_MODULE_27__.updateColor)(currentLogoColor,"logo");
...
function animateleft(){
  let popimage =  gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline();
  popimage
...
function runKvAnimations(){
  let kvtl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
    scrollTrigger: {
      trigger: ".kv_bottom",
      start: "-=200px",
      scrub: false,
...
function serviceTlSp(){
  let servicetl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
    scrollTrigger: {
...
//pc
  ...
  function serviceTlPc(){
    ...
    .from(".service_think", { x:-100, opacity: 0, duration: 0.7 },"=-0.5")
    .from(".think-text-anim", { opacity: 0, duration: 0.7 },"=-0.3")
    .from(".service-arrow-anime", { y:-50,opacity: 0, duration: 0.3 },"<50%")
    .from(".service-item1_img", { x:-50,opacity: 0, duration: 0.5},"<20%")
    .from(".service_inner-anime_1", { x:-50,opacity: 0, duration: 0.3 },"<20%")
    .from(".service-item1_txt", { opacity: 0, duration: 0.3},"<80%")
    .from(".plus-anime_1", {opacity:0, x:-100 ,duration: 0.5},"<")
    .from(".service-item2_img", { x:-50,opacity: 0, duration: 0.4},"<50%")
    .from(".service_inner-anime_2", { x:-50,opacity: 0, duration: 0.3 },"<20%")
    .from(".service-item2_txt", { opacity: 0, duration: 0.3},"<80%")
    .from(".plus-anime_2", {opacity:0, x:-100 ,duration: 0.5},"<")
    .from(".service-item3_img", { x:-50,opacity: 0, duration: 0.4},"<50%")
    .from(".service_inner-anime_3", { x:-50,opacity: 0, duration: 0.3},"<20%")
    .from(".service-item3_txt", { opacity: 0, duration: 0.3},"<80%")
...
----------------------------*/
  ...
  let reccomendtl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
    scrollTrigger: {
      trigger: "#recommended",
      start: "-=200px",
      scrub: false,
...
let planAnitl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
  scrollTrigger: {
    trigger: planTrigger,
    start: "-100px top",
    scrub: false,
...
// PLAN CONTENT ANIMATION
 ...
 let planAnitl2 = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
  scrollTrigger: {
    trigger:planTrigger,
    start: "-100px top",
    scrub: false,
...
----------------------------*/
  ...
  let newplanAnitl = gsap__WEBPACK_IMPORTED_MODULE_32__.gsap.timeline({
    scrollTrigger: {
      trigger: newplan,
      start: "-250px top",
      scrub: false,
...
/******/ })()
;
//# sourceMappingURL=main.99ab3471fc955797bf65.js.map